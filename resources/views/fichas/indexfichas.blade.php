                    ...
                    <tbody>
                        @foreach ($mostrar as $item)
                            <tr>
                                ...
                                <td>{{ $item->estado }}</td>
                                <td>{{ $item->cant_aprendices }}</td>
                                <td>{{ $item->fecha_inicio }}</td>
                                <td>{{ $item->fecha_fin }}</td>
                                <td>
                                    <a href="{{route('fichas.editar',"pan=".$item->nro_ficha)}}" class="edit" data-toggle="modal"><i
                                            class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="{{route('fichas.eliminar',$item->nro_ficha)}}" class="delete" data-toggle="modal"><i
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{route('fichas.crear')}}">
                    @csrf
