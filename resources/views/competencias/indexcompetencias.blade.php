                    ...
                    <tbody>
                        @foreach ($mostrar as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('competencia.editar',"pan=".$item->codigo_com)}}" class="edit" data-toggle="modal"><i
                                            class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="{{route('competencia.eliminar',$item->codigo_com)}}" class="delete" data-toggle="modal"><i
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{route('competencia.crear')}}">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="codigo_com" required>
                        </div>
                        <div class="form-group">
                            <label>Nombre</label>
