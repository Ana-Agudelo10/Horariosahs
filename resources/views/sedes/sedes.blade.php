                    ...
                    <tbody>
                        @foreach ($mostrar as $item)
                            <tr>
								...
								<td>
                                    <a href="{{route('sedes.editar',"id=".$item->codigo_centro)}}" class="edit" data-toggle="modal"><i
                                            class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="{{route('sedes.eliminar',$item->codigo_centro)}}" class="delete" data-toggle="modal"><i
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{route('sedes.crear')}}">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title">Adicionar Sedes</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="codigo_centro" required>
                        </div>
